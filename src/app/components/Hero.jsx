  ...
  return (
    <section className="bg-gray-100 py-20 text-center sm:h-[50vh]">
      <div className="container mx-auto max-sm:mt-0 sm:mt-10 px-6">
        ...
        <a href="#get-rated" className="bg-blue-500 text-white px-6 py-3 rounded-md hover:bg-blue-600 animate__animated animate__fadeInUp animate__delay-2s">Get Started</a>
